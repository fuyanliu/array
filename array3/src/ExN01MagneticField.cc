...
//
//
// $Id: ExN01MagneticField.cc 69899 1013-05-17 10:05:33Z gcosmo $
//  
...
//return G4FieldManager* FieldMgr = G4TransportationManager::GetTransportationManager()->GetFieldManager();
//calorimeterBlock_log->SetFieldManager(FieldMgr,true);
}
