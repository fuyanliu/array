...
{
  G4MultiFunctionalDetector* aDetector
    = new G4MultiFunctionalDetector("aPilot");
  G4VPrimitiveScorer* primitive;
  primitive = new G4PSEnergyDeposit("Edep");
  aDetector->RegisterPrimitive(primitive);
  SetSensitiveDetector("PilotALV", aDetector);

  G4MultiFunctionalDetector* bDetector
    = new G4MultiFunctionalDetector("bPilot");
  primitive = new G4PSEnergyDeposit("Edep");
  bDetector->RegisterPrimitive(primitive);
  SetSensitiveDetector("PilotBLV", bDetector);

  G4MultiFunctionalDetector* cDetector
    = new G4MultiFunctionalDetector("cPilot");
  primitive = new G4PSEnergyDeposit("Edep");
  cDetector->RegisterPrimitive(primitive);
  SetSensitiveDetector("PilotCLV", cDetector);

  G4MultiFunctionalDetector* dDetector
    = new G4MultiFunctionalDetector("dPilot");
  primitive = new G4PSEnergyDeposit("Edep");
  dDetector->RegisterPrimitive(primitive);
  SetSensitiveDetector("PilotDLV", dDetector);
