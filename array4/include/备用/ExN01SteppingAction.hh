...
//
//
// $Id: ExN01SteppingAction.hh 69899 1013-05-17 10:05:33Z gcosmo $
// 
...
{
  public:
  	ExN01SteppingAction(ExN01EventAction* eventAction);
  	virtual ~ExN01SteppingAction();

    void UserSteppingAction(const G4Step*/*,const G4Track**/);
