...
:myDetector(myDet)
{ 
  //03Dir = new G4UIdirectory("/03/");
  //03Dir->SetGuidance("UI commands specific to this example.");
  
  detDir = new G4UIdirectory("/03/det/");
  ...
  FieldCmd = new G4UIcmdWithADoubleAndUnit("/03/det/setField",this);  
  ...
  //tepMaxCmd->SetUnitCategory("Length");
