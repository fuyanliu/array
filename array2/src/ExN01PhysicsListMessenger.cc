...
#include "ExN01PhysicsListMessenger.hh"
#include "globals.hh"
...
ExN01PhysicsListMessenger::ExN01PhysicsListMessenger(ExN01PhysicsList* pPhys)
:pPhysicsList(pPhys)
{
  N01Dir = new G4UIdirectory("/N01/");
  N01Dir->SetGuidance("UI commands of this example");
  
  physDir = new G4UIdirectory("/N01/phys/");
  physDir->SetGuidance("PhysicsList control");
 
  verboseCmd = new G4UIcmdWithAnInteger("/N01/phys/verbose",this);  
  ...
  cerenkovCmd = new G4UIcmdWithAnInteger("/N01/phys/cerenkovMaxPhotons",this);  
...
ExN01PhysicsListMessenger::~ExN01PhysicsListMessenger()
{
  delete verboseCmd;
  delete cerenkovCmd;
  delete physDir;
...
/*void ExN01PhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)*/
/*{       
